...
const mockCourses: Course[] = [
  {
    ...
    description: "Learn the complete SMC framework — order blocks, liquidity, BOS, CHOCH, FVG, and premium/discount zones. The most comprehensive SMC course on TCC.",
    instructor: "goldsniper_fx",
    instructorHandle: "goldsniper_fx",
    level: "INTERMEDIATE",
    category: "smc",
    thumbnail: "📊",
    ...
    lessons: [
      ...
      { id: "l2", title: "Market Structure — BOS & CHOCH", duration: "18:45", videoUrl: "", description: "Break of structure and change of character explained", completed: false, quizQuestions: [
  ...
  },
  {
    ...
    description: "The psychological edge that separates profitable traders from the rest. Covers FOMO, revenge trading, discipline, and building a winning mindset.",
    instructor: "risk_master_99",
    instructorHandle: "risk_master_99",
    level: "BEGINNER",
    category: "psychology",
    thumbnail: "🧠",
    ...
    lessons: [
      ...
      { id: "l2", title: "Fear, Greed & FOMO", duration: "14:30", videoUrl: "", description: "Understanding your emotional triggers", completed: false, quizQuestions: [
  ...
  },
  {
    ...
    description: "The complete risk management system. Position sizing, lot calculation, drawdown management, and building a risk framework that keeps you in the game.",
    instructor: "risk_master_99",
    instructorHandle: "risk_master_99",
    level: "BEGINNER",
    category: "risk",
  ...
  },
  {
    ...
    description: "Everything you need to trade crypto — on-chain analysis, market cycles, altcoin season, Bitcoin dominance, and crypto-specific risk management.",
