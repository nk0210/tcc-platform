...
const mockMasters: MasterTrader[] = [
  {
    id: "m1", handle: "goldsniper_fx", tccId: "TCC-GL-TRD-00000001",
    skillLevel: "PRO", winRate: 71.4, profitFactor: 2.8, maxDrawdown: 4.2,
    avgRR: 2.1, totalTrades: 284, monthlyReturn: 8.5, traderTrustScore: 92,
    specialty: "XAUUSD", followers: 234, verified: true, broker: "TCC Paper",
  },
  {
    id: "m2", handle: "btc_beast", tccId: "TCC-GL-TRD-00000002",
    skillLevel: "TRADER", winRate: 68.4, profitFactor: 2.1, maxDrawdown: 6.1,
    avgRR: 1.8, totalTrades: 156, monthlyReturn: 6.2, traderTrustScore: 84,
    specialty: "BTCUSDT", followers: 128, verified: true, broker: "TCC Paper",
  },
  {
    id: "m3", handle: "eurusd_queen", tccId: "TCC-GL-TRD-00000003",
    skillLevel: "PRO", winRate: 62.9, profitFactor: 1.9, maxDrawdown: 3.8,
    avgRR: 1.6, totalTrades: 412, monthlyReturn: 4.8, traderTrustScore: 88,
    specialty: "EURUSD", followers: 189, verified: true, broker: "TCC Paper",
  },
  {
    id: "m4", handle: "risk_master_99", tccId: "TCC-GL-TRD-00000004",
    skillLevel: "ANALYST", winRate: 75.0, profitFactor: 3.2, maxDrawdown: 2.1,
    avgRR: 2.8, totalTrades: 98, monthlyReturn: 3.9, traderTrustScore: 95,
    specialty: "XAUUSD/EURUSD", followers: 312, verified: true, broker: "TCC Paper",
  },
];
...
interface CopyTradingStore {
  ...
  calculateFollowerLot: (master: MasterTrader, relationship: CopyRelationship, masterLot: number, slDistance: number, entryPrice: number) => {
    proportionalLot: number;
    riskBasedLot: number;
    multiplierLot: number;
    finalLot: number;
    riskAmount: number;
  };
}
